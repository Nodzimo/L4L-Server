...
public void OnPluginStart()
{
    ...
    g_hCvarSurvivorIncap = CreateConVar("l4l_survivor_incap_spawn_si_count", "2", "0 = Off, Number of special infected spawned when a survivor is incapacitated", CVAR_FLAGS, true, float(DISABLE), true, float(MAX_SI));
