...
/*
    ...
    1.17 (03-Mar-2023)
     - Added translation into Chinese (thanks to @apples1949).
...
public void OnMapStart()
{
    ...
    char diffEx[32];
    g_ConVarDifficultyEx.GetString(diffEx, sizeof(diffEx));

    g_bHardPlus   = StrEqual(diffEx, "Hard+", false);
    g_bExpertPlus = StrEqual(diffEx, "Impossible+", false);
...
void VoteDifficulty(int client, char[] sDifficulty)
{
    ...
    // fix for SourceMod bug, when first letter get replaced with lower-case, e.g. sDifficulty = "impossible", instead of "Impossible"
    // perhaps, they uses bugged Valve KeyValues system to store menu items data
