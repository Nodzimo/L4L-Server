...
17. [Server namer (3.2) by sheo](https://forums.alliedmods.net/showthread.php?p=2030557)
   ...
   - Если на сервере запущена игра, то в его имени выводится: название и номер сервера, режим игры и сложность (если режим поддерживает разные уровни сложности).
   - Если сервер пустой, то в его имени выводится название сборки: **Vanilla**, **Legacy**, **LMBX**, **Test**, **Dev**.
