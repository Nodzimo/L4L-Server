...
start "" /wait "%BASE_DIR%Servers/%name%/srcds" -console -game left4dead2 +map "c1m2_streets realism" -port 27020 -dev +servercfgfile l4l/dev +sm_basepath addons/sourcemod_dev
